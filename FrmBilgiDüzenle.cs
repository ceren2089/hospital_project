...
namespace Proje_Hastane
{
    public partial class FrmBilgiDüzenle : Form
    {
        ...
        {
            MskTc.Text = TCno;
            SqlCommand cmd = new SqlCommand("select*from Tbl_Hastalar where HastaTC=@p1", bgl.connection());
        ...
        {
            SqlCommand cmd2 = new SqlCommand("update Tbl_Hastalar set HastaAd=@p1,HastaSoyad=@p2,HastaTelefon=@p3,HastaSifre=@p4,HastaCinsiyet=@p5 where HastaTC=@p6", bgl.connection());
